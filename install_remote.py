...
FILES = ["__init__.py", "properties.py", "rig_builder.py", "operators.py", "ui.py", "README.md"]
...
def main():
    ...
    code = []
    code.append("import bpy, addon_utils, os, sys, importlib")
    ...
    code.append("except Exception as e: print('disable_err',e)")
